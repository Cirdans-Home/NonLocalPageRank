...
TAB = cell(NumTrial1,1);

parfor nmt1=1:NumTrial1
%     fprintf('Trial n: %d\n\n',nmt1);
...
%     fprintf('Local = %1.5f \t Nonlocal = %1.5f\n\n', LocalScores(problem,nmt1),  NLocalScores(problem,nmt1));
    ...
    TAB{nmt1} =  table(dataset, num_nodes, num_edges, density, trial, alpha, c_nonlocal, accuracy_nonlocal, c_local, accuracy_local);
    disp(TAB{nmt1}(TAB{nmt1}.dataset == dataset,5:end))
end


for nmt1=1:NumTrial1
    Results_TAB = [Results_TAB; TAB{nmt1}];
end
